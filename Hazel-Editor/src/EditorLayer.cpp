...
namespace Hazel {
    ...
    void EditorLayer::OnAttach()
    {
        ...
        m_CheckboardTexture = Texture2D::Create("Sandbox/assets/textures/Checkerboard.png");
        m_ChernoTexture = Texture2D::Create("Sandbox/assets/textures/ChernoLogo.png");
    ...
    void EditorLayer::OnUpdate(Timestep ts)
    {
...

        {
            ...
            for (int i = 0; i < m_nQuads; i++)
            {
                ...
                Renderer2D::DrawRotatedQuad(position, rotation, size, color);
            }
            // Renderer2D::DrawRotatedQuad({ 0.5f, 0.5f }, glm::radians(30.0f), { 1.2f, 0.6f }, { 0.2f, 0.8f, 0.3f, 1.0f });
            Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckboardTexture, 10.0f, { 1.0f, 1.0f, 1.0f, 1.0f });
            Renderer2D::DrawRotatedQuad({ -5.0f, 5.0f, 0.1f }, time * 45.0f, { 1.0f, 1.0f }, m_ChernoTexture, 2);
    ...
    void EditorLayer::OnImGuiRender()
    {
        ...
        ImGui::Image((void*)textureID, ImVec2(120.0f, 90.0f), ImVec2{ 0, 1 }, ImVec2{ 1, 0 });
